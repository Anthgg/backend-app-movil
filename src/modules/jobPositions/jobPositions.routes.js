...
router.post('/', authorizeRoles('ADMIN', 'RRHH'), requirePermission('job_positions.create'), jobPositionController.createJobPosition);
router.put('/:id', authorizeRoles('ADMIN', 'RRHH'), requirePermission('job_positions.update'), jobPositionController.updateJobPosition);
router.patch('/:id/status', authorizeRoles('ADMIN', 'RRHH'), requirePermission('job_positions.update'), jobPositionController.updateJobPositionStatus);
router.delete('/:id', authorizeRoles('ADMIN', 'RRHH'), requirePermission('job_positions.delete'), jobPositionController.deleteJobPosition);
