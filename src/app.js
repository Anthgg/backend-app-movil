...
app.get('/routes', (req, res) => {
  res.json({
    ...
    routes: [
      ...
      { method: 'PUT',  path: '/api/workers/:workerId/labor-assignment' },
      ...
      { method: 'GET',  path: '/api/workers/:workerId/location-history' },
      ...
      { method: 'GET',  path: '/api/reports/work-crews/columns' },
      { method: 'POST', path: '/api/reports/work-crews/preview' },
      { method: 'POST', path: '/api/reports/work-crews/pdf' },
      { method: 'POST', path: '/api/reports/work-crews/export/pdf' },
      { method: 'POST', path: '/api/reports/work-crews/export/excel' },
      ...
      { method: 'GET',  path: '/profile/sessions' },
      { method: 'DELETE', path: '/profile/sessions/other' },
      { method: 'DELETE', path: '/profile/sessions/:id' },
      { method: 'POST', path: '/profile/sessions/:id/trust' },
      ...
      { method: 'GET',  path: '/api/profile/sessions' },
      { method: 'DELETE', path: '/api/profile/sessions/other' },
      { method: 'DELETE', path: '/api/profile/sessions/:id' },
      { method: 'POST', path: '/api/profile/sessions/:id/trust' },
